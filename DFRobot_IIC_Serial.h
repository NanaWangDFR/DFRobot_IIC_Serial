...
#define IIC_ADDR_FIXED       0x10    //IIC地址的第4/3位为固定位,分别为1和0;
...
#ifdef ARDUINO_ARCH_NRF5
  #define IIC_BUFFER_SIZE      63       //micro:bit IIC一次最大传输63字节
#elif ARDUINO_ARCH_MPYTHON
  #define IIC_BUFFER_SIZE      31       //掌控IIC一次最大传输31字节
#else
  #define IIC_BUFFER_SIZE      32       //UNO、Mega2560、Leonardo（AVR系列） IIC一次最大传输32字节
#endif
...
public:
   ...
   * @param baud 串口波特率
   * @n 除了支持常见的9600、57600、115200等波特率，还支持:
